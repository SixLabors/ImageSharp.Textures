...
#pragma warning restore CA1707 // Identifiers should not contain underscores
{
    ...
    /// <inheritdoc />
    public readonly PixelOperations<D32_FLOAT_S8X24_UINT> CreatePixelOperations() => new();
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(D32_FLOAT_S8X24_UINT other) => this.PackedValue.Equals(other.PackedValue);
    ...
    private static ulong Pack(ref Vector2 vector)
    {
        ...
        return
            FloatHelper.PackFloatToFloat32(vector.X)
