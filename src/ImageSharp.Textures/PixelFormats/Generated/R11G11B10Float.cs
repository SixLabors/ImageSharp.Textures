...
public partial struct R11G11B10Float : IPixel<R11G11B10Float>, IPackedVector<uint>
{
    ...
    /// <inheritdoc />
    public readonly PixelOperations<R11G11B10Float> CreatePixelOperations() => new();
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(R11G11B10Float other) => this.PackedValue.Equals(other.PackedValue);
    ...
    private static uint Pack(ref Vector3 vector)
    {
        ...
        return
            FloatHelper.PackFloatToFloat11(vector.X)
            | (FloatHelper.PackFloatToFloat11(vector.Y) << 11)
            | (FloatHelper.PackFloatToFloat10(vector.Z) << 22);
    }
}
