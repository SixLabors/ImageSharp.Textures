...
public partial struct Rgba128Float : IPixel<Rgba128Float>
{
    ...
    /// <inheritdoc />
    public readonly PixelOperations<Rgba128Float> CreatePixelOperations() => new();
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(Rgba128Float other) => this.R.Equals(other.R) && this.G.Equals(other.G) && this.B.Equals(other.B) && this.A.Equals(other.A);

    /// <inheritdoc />
    public override readonly string ToString() => FormattableString.Invariant($"Rgba128Float({this.R}, {this.G}, {this.B}, {this.A})");
