...
public partial struct Rg64Float : IPixel<Rg64Float>
{
    ...
    /// <inheritdoc />
    public readonly PixelOperations<Rg64Float> CreatePixelOperations() => new();
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(Rg64Float other) => this.R.Equals(other.R) && this.G.Equals(other.G);

    /// <inheritdoc />
    public override readonly string ToString() => FormattableString.Invariant($"Rg64Float({this.R}, {this.G})");

    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override readonly int GetHashCode() => HashCode.Combine(this.R, this.G);
}
