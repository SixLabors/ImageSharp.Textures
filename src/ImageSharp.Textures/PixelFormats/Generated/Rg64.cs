...
public partial struct Rg64 : IPixel<Rg64>
{
    ...
    /// <inheritdoc />
    public readonly PixelOperations<Rg64> CreatePixelOperations() => new();
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(Rg64 other) => this.R.Equals(other.R) && this.G.Equals(other.G);

    /// <inheritdoc />
    public override readonly string ToString() => FormattableString.Invariant($"Rg64({this.R}, {this.G})");
