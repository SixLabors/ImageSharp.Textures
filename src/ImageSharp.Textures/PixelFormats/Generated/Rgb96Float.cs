...
public partial struct Rgb96Float : IPixel<Rgb96Float>
{
    ...
    /// <inheritdoc />
    public readonly PixelOperations<Rgb96Float> CreatePixelOperations() => new();
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(Rgb96Float other) => this.R.Equals(other.R) && this.G.Equals(other.G) && this.B.Equals(other.B);

    /// <inheritdoc />
    public override readonly string ToString() => FormattableString.Invariant($"Rgb96Float({this.R}, {this.G}, {this.B})");
