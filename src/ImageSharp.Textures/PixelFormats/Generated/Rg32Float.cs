...
public partial struct Rg32Float : IPixel<Rg32Float>, IPackedVector<uint>
{
    ...
    /// <inheritdoc />
    public readonly PixelOperations<Rg32Float> CreatePixelOperations() => new();
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(Rg32Float other) => this.PackedValue.Equals(other.PackedValue);
    ...
    private static uint Pack(ref Vector2 vector)
    {
        ...
        return
            FloatHelper.PackFloatToFloat16(vector.X)
            | (FloatHelper.PackFloatToFloat16(vector.Y) << 16);
    }
}
