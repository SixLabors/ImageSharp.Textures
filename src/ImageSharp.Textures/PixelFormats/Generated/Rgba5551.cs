...
public partial struct Rgba5551 : IPixel<Rgba5551>, IPackedVector<ushort>
{
    ...
    /// <inheritdoc />
    public readonly PixelOperations<Rgba5551> CreatePixelOperations() => new();
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(Rgba5551 other) => this.PackedValue.Equals(other.PackedValue);
