...
public struct Fp32 : IPixel<Fp32>, IPackedVector<float>
{
    ...
    /// <inheritdoc />
    public readonly PixelOperations<Fp32> CreatePixelOperations() => new();
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly Vector4 ToVector4() => new(this.PackedValue);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly Vector<float> ToVector() => new(this.PackedValue);
    ...
    {
        Vector<float> vector = this.ToVector();
