...
public struct R16Float : IPixel<R16Float>, IPackedVector<ushort>
{
    ...
    /// <inheritdoc />
    public readonly PixelOperations<R16Float> CreatePixelOperations() => new();
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(R16Float other) => this.PackedValue.Equals(other.PackedValue);
