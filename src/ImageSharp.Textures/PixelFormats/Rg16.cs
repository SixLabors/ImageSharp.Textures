...
public struct Rg16 : IPixel<Rg16>, IPackedVector<ushort>
{
    ...
    /// <inheritdoc />
    public readonly PixelOperations<Rg16> CreatePixelOperations() => new();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly Vector2 ToVector2() => new Vector2(this.PackedValue & 0xFF, (this.PackedValue >> 8) & 0xFF) / Max;
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(Rg16 other) => this.PackedValue.Equals(other.PackedValue);
