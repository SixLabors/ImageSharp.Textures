...
internal static class ColorSpaceConversion
{
    ...
    private static readonly Vector4 Multiplier16Bit = new(Max16Bit, Max16Bit, Max16Bit, Max16Bit);

    private static readonly Vector4 Multiplier10Bit = new(Max10Bit, Max10Bit, Max10Bit, 3F);

    private static readonly Vector4 Multiplier8Bit = new(Max8Bit, Max8Bit, Max8Bit, Max8Bit);
