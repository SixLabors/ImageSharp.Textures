...
internal struct Bc6h : IBlock<Bc6h>
{
    ...
    private static readonly Bc6HModeDescriptor[][] ModeDescriptors =
    [
        [
    ...
    [
        new Bc6hModeInfo(0x00, 1, true,  3, [[new LdrColorA(10, 10, 10, 0), new LdrColorA(5, 5, 5, 0)], [new LdrColorA(5, 5, 5, 0), new LdrColorA(5, 5, 5, 0)]]), // Mode 1
        new Bc6hModeInfo(0x01, 1, true,  3, [[new LdrColorA(7, 7, 7, 0), new LdrColorA(6, 6, 6, 0)], [new LdrColorA(6, 6, 6, 0), new LdrColorA(6, 6, 6, 0)]]), // Mode 2
        new Bc6hModeInfo(0x02, 1, true,  3, [[new LdrColorA(11, 11, 11, 0), new LdrColorA(5, 4, 4, 0)], [new LdrColorA(5, 4, 4, 0), new LdrColorA(5, 4, 4, 0)]]), // Mode 3
        new Bc6hModeInfo(0x06, 1, true,  3, [[new LdrColorA(11, 11, 11, 0), new LdrColorA(4, 5, 4, 0)], [new LdrColorA(4, 5, 4, 0), new LdrColorA(4, 5, 4, 0)]]), // Mode 4
        new Bc6hModeInfo(0x0a, 1, true,  3, [[new LdrColorA(11, 11, 11, 0), new LdrColorA(4, 4, 5, 0)], [new LdrColorA(4, 4, 5, 0), new LdrColorA(4, 4, 5, 0)]]), // Mode 5
        new Bc6hModeInfo(0x0e, 1, true,  3, [[new LdrColorA(9, 9, 9, 0), new LdrColorA(5, 5, 5, 0)], [new LdrColorA(5, 5, 5, 0), new LdrColorA(5, 5, 5, 0)]]), // Mode 6
        new Bc6hModeInfo(0x12, 1, true,  3, [[new LdrColorA(8, 8, 8, 0), new LdrColorA(6, 5, 5, 0)], [new LdrColorA(6, 5, 5, 0), new LdrColorA(6, 5, 5, 0)]]), // Mode 7
        new Bc6hModeInfo(0x16, 1, true,  3, [[new LdrColorA(8, 8, 8, 0), new LdrColorA(5, 6, 5, 0)], [new LdrColorA(5, 6, 5, 0), new LdrColorA(5, 6, 5, 0)]]), // Mode 8
        new Bc6hModeInfo(0x1a, 1, true,  3, [[new LdrColorA(8, 8, 8, 0), new LdrColorA(5, 5, 6, 0)], [new LdrColorA(5, 5, 6, 0), new LdrColorA(5, 5, 6, 0)]]), // Mode 9
        new Bc6hModeInfo(0x1e, 1, false, 3, [[new LdrColorA(6, 6, 6, 0), new LdrColorA(6, 6, 6, 0)], [new LdrColorA(6, 6, 6, 0), new LdrColorA(6, 6, 6, 0)]]), // Mode 10
        new Bc6hModeInfo(0x03, 0, false, 4, [[new LdrColorA(10, 10, 10, 0), new LdrColorA(10, 10, 10, 0)], [new LdrColorA(0, 0, 0, 0), new LdrColorA(0, 0, 0, 0)]]), // Mode 11
        new Bc6hModeInfo(0x07, 0, true,  4, [[new LdrColorA(11, 11, 11, 0), new LdrColorA(9, 9, 9, 0)], [new LdrColorA(0, 0, 0, 0), new LdrColorA(0, 0, 0, 0)]]), // Mode 12
        new Bc6hModeInfo(0x0b, 0, true,  4, [[new LdrColorA(12, 12, 12, 0), new LdrColorA(8, 8, 8, 0)], [new LdrColorA(0, 0, 0, 0), new LdrColorA(0, 0, 0, 0)]]), // Mode 13
        new Bc6hModeInfo(0x0f, 0, true,  4, [[new LdrColorA(16, 16, 16, 0), new LdrColorA(4, 4, 4, 0)], [new LdrColorA(0, 0, 0, 0), new LdrColorA(0, 0, 0, 0)]]), // Mode 14
    ];
