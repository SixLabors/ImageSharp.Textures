...
internal static class DdsHeaderExtensions
{
    ...
    /// </returns>
    public static bool IsCubemap(this DdsHeader ddsHeader) => (ddsHeader.Caps2 & DdsCaps2.Cubemap) != 0;
    ...
    /// </returns>
    public static bool IsVolumeTexture(this DdsHeader ddsHeader) => (ddsHeader.Caps2 & DdsCaps2.Volume) != 0;
    ...
    /// </value>
    public static bool IsCompressed(this DdsHeader ddsHeader) => (ddsHeader.Flags & DdsFlags.LinearSize) != 0;
    ...
    /// </value>
    public static bool HasAlpha(this DdsHeader ddsHeader) => (ddsHeader.PixelFormat.Flags & DdsPixelFormatFlags.AlphaPixels) != 0;
    ...
    /// </value>
    public static bool HasMipmaps(this DdsHeader ddsHeader) => (ddsHeader.Caps1 & DdsCaps1.MipMap) != 0 && (ddsHeader.Flags & DdsFlags.MipMapCount) != 0;
    ...
    public static int TextureCount(this DdsHeader ddsHeader) => ddsHeader.HasMipmaps() ? (int)ddsHeader.MipMapCount : 1;
    ...
    /// otherwise <c>false</c>.
    /// </returns>
    public static bool ShouldHaveDxt10Header(this DdsHeader ddsHeader) => (ddsHeader.PixelFormat.Flags == DdsPixelFormatFlags.FourCC) && (ddsHeader.PixelFormat.FourCC == DdsFourCc.DX10);
    ...
    /// </returns>
    public static bool AreDimensionsSet(this DdsHeader ddsHeader) => (ddsHeader.Flags & DdsFlags.Width) != 0 && (ddsHeader.Flags & DdsFlags.Height) != 0;
    ...
    public static DdsSurfaceType[]? GetExistingCubemapFaces(this DdsHeader ddsHeader)
    {
        ...
        DdsSurfaceType[] result = new DdsSurfaceType[depth];
        int index = 0;
