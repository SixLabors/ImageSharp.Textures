...
internal sealed class KtxDecoderCore
{
    ...
    public Texture DecodeTexture(Stream stream)
    {
        ...
        KtxProcessor ktxProcessor = new KtxProcessor(this.ktxHeader);
    ...
    public ITextureInfo Identify(Stream currentStream)
    {
        ...
        TextureInfo textureInfo = new TextureInfo(new TextureTypeInfo((int)this.ktxHeader.PixelDepth), (int)this.ktxHeader.Width, (int)this.ktxHeader.Height);
