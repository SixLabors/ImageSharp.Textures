...
internal sealed class Ktx2DecoderCore
{
    ...
    public Texture DecodeTexture(Stream stream)
    {
        ...
        LevelIndex[] levelIndices = new LevelIndex[this.ktxHeader.LevelCount];
        ...
        {
            FlatTexture flatTexture = new FlatTexture();
    ...
    public ITextureInfo Identify(Stream currentStream)
    {
        ...
        TextureInfo textureInfo = new TextureInfo(new TextureTypeInfo((int)this.ktxHeader.PixelDepth), (int)this.ktxHeader.PixelWidth, (int)this.ktxHeader.PixelHeight);
