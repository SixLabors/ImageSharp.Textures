...
{
    private static readonly Lazy<ImageSharp.Configuration> ConfigurationLazy = new(CreateDefaultConfiguration);
    ...
    private static readonly FileInfo TestAssemblyFile =
        new(typeof(TestEnvironment).GetTypeInfo().Assembly.Location);
    ...
    {
        ImageSharp.Configuration cfg = new();
