...
namespace SixLabors.ImageSharp.Textures.Tests
{
    ...
    public class TestFile
    {
        ...
        /// The <see cref="string"/>.
        /// </returns>
        public static string GetInputFileFullPath(string file) => Path.Combine(InputImagesDirectory, file).Replace('\\', Path.DirectorySeparatorChar);
        ...
        /// </returns>
        public static TestFile Create(string file) => Cache.GetOrAdd(file, (string fileName) => new TestFile(GetInputFileFullPath(file)));
        ...
        /// The <see cref="string"/>.
        /// </returns>
        public string GetFileName(object value) => $"{this.FileNameWithoutExtension}-{value}{Path.GetExtension(this.FullPath)}";
        ...
        /// The <see cref="string"/>.
        /// </returns>
        public string GetFileNameWithoutExtension(object value) => this.FileNameWithoutExtension + "-" + value;
