...
function Cubemap-ToKtx {
    ...
    .(Join-Path $PSScriptRoot toktx.exe) --cubemap --upper_left_maps_to_s0t0 --automipmap (Join-Path $SaveFolder "cubemap-ul-mips.ktx") "cubemap-positive-x.ppm" "cubemap-negative-x.ppm" "cubemap-positive-y.ppm" "cubemap-negative-y.ppm" "cubemap-positive-z.ppm" "cubemap-negative-z.ppm"
    ...
    .(Join-Path $PSScriptRoot toktx.exe) --cubemap --lower_left_maps_to_s0t0 --automipmap (Join-Path $SaveFolder "cubemap-ll-mips.ktx") "cubemap-positive-x.ppm" "cubemap-negative-x.ppm" "cubemap-positive-y.ppm" "cubemap-negative-y.ppm" "cubemap-positive-z.ppm" "cubemap-negative-z.ppm"
        ...
        foreach ($CurrentType in $Types) 
        {
            foreach ($CurrentColourSpace in $ColourSpaces) 
            {
                ...
                if ($Speed.Length > 0) 
                {
                    ...
                    .(Join-Path $PSScriptRoot PVRTexToolCLI.exe) -cube -q $Speed-i "cubemap-positive-x.png","cubemap-negative-x.png","cubemap-positive-y.png","cubemap-negative-y.png","cubemap-positive-z.png","cubemap-negative-z.png" -o (Join-Path $SaveFolder "cubemap-mips-$FileFormat.pvr") -m -f $ProcessFormat
                    .(Join-Path $PSScriptRoot PVRTexToolCLI.exe) -cube -q $Speed -i "c ubemap-positive-x.png","cubemap-negative-x.png","cubemap-positive-y.png","cubemap-negative-y.png","cubemap-positive-z.png","cubemap-negative-z.png" -o (Join-Path $SaveFolder "cubemap-no-mips-$FileFormat.pvr") -f $ProcessFormat

                } 
                else 
                {

                    .(Join-Path $PSScriptRoot PVRTexToolCLI.exe) -cube -i "cubemap-positive-x.png","cubemap-negative-x.png","cubemap-positive-y.png","cubemap-negative-y.png","cubemap-positive-z.png","cubemap-negative-z.png" -o (Join-Path $SaveFolder "cubemap-mips-$FileFormat.pvr") -m -f $ProcessFormat
...
function Flat-NvDxt {
    ...
    foreach ($Format in $Formats) 
    {
        ...
        .(Join-Path $PSScriptRoot nvdxt.exe) -file flat-pot-alpha.png -$Format -output (Join-Path $SaveFolder "flat-pot-alpha-mips-$Format.dds")
...
function Flat-ToKtx {
    ...
    .(Join-Path $PSScriptRoot toktx.exe) --upper_left_maps_to_s0t0 --automipmap (Join-Path $SaveFolder "flat-pot-alpha-ul-mips.ktx") "flat-pot-alpha.ppm"
    ...
    .(Join-Path $PSScriptRoot toktx.exe) --lower_left_maps_to_s0t0 --automipmap (Join-Path $SaveFolder "flat-pot-alpha-ll-mips.ktx") "flat-pot-alpha.ppm"
    ...
    .(Join-Path $PSScriptRoot toktx.exe) --upper_left_maps_to_s0t0 --automipmap (Join-Path $SaveFolder "flat-rect-alpha-ul-mips.ktx") "flat-rect-alpha.ppm"
    ...
    .(Join-Path $PSScriptRoot toktx.exe) --lower_left_maps_to_s0t0 --automipmap (Join-Path $SaveFolder "flat-rect-alpha-ll-mips.ktx") "flat-rect-alpha.ppm"
    ...
    .(Join-Path $PSScriptRoot toktx.exe) --upper_left_maps_to_s0t0 --automipmap (Join-Path $SaveFolder "flat-square-alpha-ul-mips.ktx") "flat-square-alpha.ppm"
    ...
    .(Join-Path $PSScriptRoot toktx.exe) --lower_left_maps_to_s0t0 --automipmap (Join-Path $SaveFolder "flat-square-alpha-ll-mips.ktx") "flat-square-alpha.ppm"
...
function Flat-Basis {
    ...
    .(Join-Path $PSScriptRoot basisu.exe) -file "flat-pot-alpha.png" -mipmap -output_file (Join-Path $SaveFolder "flat-pot-alpha-mips.basis")
    .(Join-Path $PSScriptRoot basisu.exe) -file "flat-pot-alpha.png" -output_file (Join-Path $SaveFolder "flat-pot-alpha-no-mips.basis")
    .(Join-Path $PSScriptRoot basisu.exe) -file "flat-pot-no-alpha.png" -mipmap -output_file (Join-Path $SaveFolder "flat-pot-alpha-mips.basis")
    ...
    .(Join-Path $PSScriptRoot basisu.exe) -file "flat-rect-alpha.png" -mipmap -output_file (Join-Path $SaveFolder "flat-rect-alpha-mips.basis")
    ...
    .(Join-Path $PSScriptRoot basisu.exe) -file "flat-rect-no-alpha.png" -mipmap -output_file (Join-Path $SaveFolder "flat-rect-alpha-mips.basis")
    ...
    .(Join-Path $PSScriptRoot basisu.exe) -file "flat-square-alpha.png" -mipmap -output_file (Join-Path $SaveFolder "flat-square-alpha-mips.basis")
    ...
    .(Join-Path $PSScriptRoot basisu.exe) -file "flat-square-no-alpha.png" -mipmap -output_file (Join-Path $SaveFolder "flat-square-alpha-mips.basis")
        ...
        foreach ($CurrentType in $Types) 
        {
            foreach ($CurrentColourSpace in $ColourSpaces) 
            {
                ...
                if ($Speed.Length > 0) 
                {
                    ...
                    .(Join-Path $PSScriptRoot PVRTexToolCLI.exe) -q $Speed -i "flat-pot-alpha.png" -o (Join-Path $SaveFolder "flat-pot-alpha-mips-$FileFormat.pvr") -m -f $ProcessFormat
                    ...
                    .(Join-Path $PSScriptRoot PVRTexToolCLI.exe) -q $Speed -i "flat pot-no-alpha.png" -o (Join-Path $SaveFolder "flat-pot-no-alpha-mips-$FileFormat.pvr") -m -f $ProcessFormat
                ...
                else
                {
                    ...
                    .(Join-Path $PSScriptRoot PVRTexToolCLI.exe) -i "flat-pot-alpha.png" -o (Join-Path $SaveFolder "flat-pot-alpha-mips-$FileFormat.pvr") -m -f $ProcessFormat
                    ...
                    .(Join-Path $PSScriptRoot PVRTexToolCLI.exe) -i "flat-pot-no-alpha.png" -o (Join-Path $SaveFolder "flat-pot-no-alpha-mips-$FileFormat.pvr") -m -f $ProcessFormat
